...
export interface ApiLoaiLopLoaiLop extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Lo\u1EA1i l\u1ED1p';
    pluralName: 'loai-lops';
    singularName: 'loai-lop';
  };
  options: {
...
export interface ApiSanPhamSanPham extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    imageUrl: Schema.Attribute.Media<
      ...
      true
    >;
    loai_lop: Schema.Attribute.Relation<'manyToOne', 'api::loai-lop.loai-lop'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    models: Schema.Attribute.Component<'item.mau-ma', true>;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
